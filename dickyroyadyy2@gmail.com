...
on:
  workflow_dispatch:
    inputs:
      agent_name:
        description: 'dickyroyadyy2@gmail.com'
        required: true
        default: 'dickyroyadyy2@gmail.com'
      agent_description:
        description: 'Cuan'
        required: true
        default: 'dickyroyadyy2@gmail.com AI Agent'
  ...
  verify:
    ...
    steps:
      ...
      - name: Step 3 - Link Human to Agent
        run: |
          node scripts/manualLinkHumanToAgent.js --challenge '{"name": "dickyroyadyy2@gmail.com", "description": "dickyroyadyy2@gmail.com AI Agent"}'
